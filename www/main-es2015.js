...
const routes = [
    ...
    { path: 'layout', component: _containers_layout_layout_component__WEBPACK_IMPORTED_MODULE_3__["LayoutComponent"], children: [
            ...
            { path: 'kimimo', loadChildren: () => __webpack_require__.e(/*! import() | kimimo-kimimo-module */ "kimimo-kimimo-module").then(__webpack_require__.bind(null, /*! ../kimimo/kimimo.module */ "./src/app/kimimo/kimimo.module.ts")).then(mod => mod.KimimoModule) }
        ] },
];
